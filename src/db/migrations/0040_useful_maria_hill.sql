...
ALTER TABLE "daily_tasks" DROP CONSTRAINT "daily_tasks_assigned_by_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "daily_tasks" DROP CONSTRAINT "daily_tasks_related_verified_dealer_id_verified_dealers_id_fk";
--> statement-breakpoint
ALTER TABLE "daily_tasks" DROP CONSTRAINT "daily_tasks_related_dealer_id_dealers_id_fk";
--> statement-breakpoint
ALTER TABLE "daily_tasks" DROP CONSTRAINT "daily_tasks_pjp_id_permanent_journey_plans_id_fk";
--> statement-breakpoint
ALTER TABLE "daily_tasks" DROP CONSTRAINT "daily_tasks_site_id_technical_sites_id_fk";
--> statement-breakpoint
...
ALTER TABLE "tso_meetings" ADD COLUMN "meet_image_url" varchar(300);--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_projection_snapshot" ON "projection_reports" USING btree ("report_date","order_dealer_name","collection_dealer_name","institution","zone");--> statement-breakpoint
